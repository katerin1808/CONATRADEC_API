...
namespace CONATRADEC_API.Controllers
{
    public class MunicipioController : Controller
    {
            ...
            [FromBody] MunicipioCreateRequest? req)
        {
            ...
            {
                return BadRequest(
                    "No se recibieron los datos del municipio.");
            }
            ...
            ListarTodosConDepartamentoYpais()
        {
            ...
            // Una búsqueda válida sin registros responde 200 OK con [].
            ...
            ListarPorDepartamento(int departamentoId)
        {
            ...
            // El departamento sí existe; no tener municipios es un resultado
            // válido y se devuelve como una colección vacía.
            return Ok(municipios);
        }
